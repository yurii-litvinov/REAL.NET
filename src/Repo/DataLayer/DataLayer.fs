...
and IDataModel =
    interface
        ...
        abstract CreateNode: name: string * func: Option<IDataElement> -> IDataNode

        /// Creates new Generalization edge with given source and target.
        abstract CreateGeneralization: ``class``: IDataElement * source: IDataElement * target: IDataElement -> IGeneralization

        /// Creates new possibly unconnected Generalization edge.
        abstract CreateGeneralization: ``class``: IDataElement * source: IDataElement option * target: IDataElement option -> IGeneralization
