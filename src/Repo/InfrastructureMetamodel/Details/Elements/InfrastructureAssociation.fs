...
type InfrastructureAssociation(edge: ILanguageAssociation, pool: InfrastructurePool, repo: ILanguageRepository) =
   inherit InfrastructureEdge(edge, pool, repo)
   interface IInfrastructureAssociation with
