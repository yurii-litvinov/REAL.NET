...
type LanguageAssociation(edge: IAttributeAssociation, pool: LanguagePool, repo: IAttributeRepository) =
   inherit LanguageEdge(edge, pool, repo)
   interface ILanguageAssociation with
