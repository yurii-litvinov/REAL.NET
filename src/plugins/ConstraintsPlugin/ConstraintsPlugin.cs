...
namespace ConstraintsPlugin
{
    ...
    public class ConstraintsPlugin : IPlugin<PluginConfig>
    {
        ...
        public void SetConfig(PluginConfig config)
        {
            ...
            config.OnMainModelChanged = this.OnModelChanged;
            this.scene = (Scene)config.Scene;
            this.ChangeModel += new Action<string>(config.ChangeModel);
            this.ChangeSelectorVisibility += new Action<bool>(config.ChangeModelSelectorVisibility);
