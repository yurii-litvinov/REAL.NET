...
let authors = [ "Yurii Litvinov"; "Elizaveta Kuzmina"; "Ivan Nebogatikov" ]
...
let doNotCopyBinaries = ["WpfEditor"; "WpfControlsLib"]
#else
...
let gitRaw = environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/yurii-litvinov"
